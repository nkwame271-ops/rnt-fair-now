...
import RegulatorTaxAndFees from "./RegulatorTaxAndFees";
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground flex items-center gap-2">
          <Settings className="h-7 w-7 text-primary" /> Templates
        </h1>
        <p className="text-muted-foreground mt-1">Configure the standardized tenancy agreement, GRA Tax workflow, and Service Fee engine.</p>
      </div>

      <Tabs defaultValue="agreement" className="space-y-6">
        <TabsList>
          <TabsTrigger value="agreement">Agreement</TabsTrigger>
          <TabsTrigger value="tax-fees">GRA Tax & Service Fees</TabsTrigger>
        </TabsList>

        <TabsContent value="tax-fees">
          <RegulatorTaxAndFees />
        </TabsContent>
