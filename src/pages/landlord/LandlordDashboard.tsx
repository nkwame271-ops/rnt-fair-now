        ...
        {!registrationFeePaid && (
          <Alert className="border-warning bg-warning/10 border-2">
            ...
            <AlertDescription className="flex flex-col sm:flex-row sm:items-center gap-3 mt-1">
              <span className="text-muted-foreground">Your registration fee (GH₵ 35) is unpaid. Pay now to activate your Landlord ID and access all platform features.</span>
              <Button onClick={handlePayRegistrationFee} disabled={payingFee} size="sm" className="shrink-0">
                <CreditCard className="mr-2 h-4 w-4" />
                {payingFee ? "Redirecting..." : "Pay GH₵ 35 Now"}
              </Button>
            </AlertDescription>
          </Alert>
        )}
